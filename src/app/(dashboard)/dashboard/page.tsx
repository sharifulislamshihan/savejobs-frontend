...
const DashboardPage = () => {
    ...
    useEffect(() => {
        ...
        console.log("this user from overview",user);
            ...
            <SidebarInset>
                ...
                <div className="flex flex-1 flex-col gap-4 p-4 pt-0 mx-3 lg:mx-5 xl:mx-10">
                    <div className="space-y-8 mt-10">
                        ...
                        {/* overview */}
                        <div className="grid gap-4 lg:gap-5 xl:gap-10 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                            {statCards.map((card) => (
                                <Card
                                    key={card.title}
                                ...
                                >
                                    <CardHeader className="flex flex-row items-center justify-between space-y-0">
                                        <CardTitle className=" text-md lg:text-2xl xl:text-3xl font-medium text-gray-600 dark:text-gray-300">{card.title}</CardTitle>
